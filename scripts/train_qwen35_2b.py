#!/usr/bin/env python3
"""Train Qwen3.5-2B-4bit MLX LoRA."""
...
data_dir = Path('/tmp/qwen35_2b_data')
...
output_dir = Path('adapters/qwen3.5/2b/mlx/')
...
args.lora_parameters = {"rank": 4, "alpha": 8, "dropout": 0.05, "scale": 2.0}

print(f'Training {args.model} -> {output_dir}', flush=True)
run(args)
